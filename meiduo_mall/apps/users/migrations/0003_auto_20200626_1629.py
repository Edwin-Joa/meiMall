    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.CharField(blank=True, default='', max_length=40, null=True, verbose_name='电子邮箱')),
                ...
                ('province', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='procince_addresses', to='areas.Area', verbose_name='省')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='addresses', to=settings.AUTH_USER_MODEL, verbose_name='地址')),
            ],
            options={
                'verbose_name': '用户地址',
